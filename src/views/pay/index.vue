          ...
          <van-radio-group v-model="radio">
            <van-cell-group>
              ...
              <van-cell @click="radio = '2'">
                <template #title>
                  <img src="http://www.lgstatic.com/lg-app-fed/pay/images/ali_b787e2f4.png">
                  <span>支付宝支付</span>
                </template>
                <template #right-icon>
                  <van-radio name="2" />
...
import { createOrder, getPayResult, initPayment } from '@/services/pay'
